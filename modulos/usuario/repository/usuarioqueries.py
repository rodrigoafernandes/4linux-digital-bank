...
query_find_all = 'SELECT usuario.id, usuario.nome, usuario.login, usuario.password, usuario.admin FROM Usuario usuario'
...
query_delete = 'DELETE FROM Usuario WHERE Usuario.id = %s'
